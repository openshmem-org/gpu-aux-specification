...
respect to \emph{memory domains}. Each \ac{PE} exposes two memory domains: the
default symmetric heap in host memory and the \ac{GPU} symmetric heap in device
memory, as shown in \cref{fig:mem-domains}. \FUNC{shmem\_fence} orders the
